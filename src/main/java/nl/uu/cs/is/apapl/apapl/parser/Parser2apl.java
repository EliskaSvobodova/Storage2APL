...
import main.java.nl.uu.cs.is.apapl.apapl.data.*;
import main.java.nl.uu.cs.is.apapl.apapl.program.*;
import main.java.nl.uu.cs.is.apapl.apapl.plans.*;
import main.java.nl.uu.cs.is.apapl.apapl.*;
...
public class Parser2apl implements Parser2aplConstants {
        ...
        private void throwError(String err) throws ParseException {
                ...
                String errorMsg = err + " at line " + (errorLine+beliefLines) + ", column " + errorColumn + ":\u005cn";
                errorMsg += content.split("\u005cn")[errorLine-1] + "\u005cn";
 ...
 Query q=null; APLFunction m; ArrayList<Literal> l=null;
    ...
    if (jj_2_1(2147483647)) {
                  throwError("Missing required postcondition of beliefupdate: \u005c"" + m.toString() + "\u005c"");
      jj_consume_token(ACCR);
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NOT:
  ...
  final public void Goalbase(Goalbase goals) throws ParseException {
        Goal g;
    label_4:
    while (true) {
      g = Goal();
 ...
 Query q;
  ...
  final public void Planbase(Planbase plans) throws ParseException {
 PlanSeq p;
    p = PlanSeq();
                       plans.addPlan(p);
  }
 ...
 Plan p; APLFunction af;
  ...
  final public Plan BasicPlanWithVar() throws ParseException {
 Plan p; APLFunction af;
 ...
 Token t;
  ...
  final public Plan BasicPlan() throws ParseException {
 Plan p; APLFunction af;
 ...
 ArrayList<Literal> literals; APLIdent moduleId;
  ...
  final public AssertBelief AssertBeliefAction() throws ParseException {
 ...
 Goal g; Token t; APLIdent moduleId = null;
  ...
  final public Test Test2(APLIdent moduleId) throws ParseException {
        Test t, t2;
        Query q;
 ...
 Query q;
  ...
  final public Query Queries() throws ParseException {
        Query v, w;
    v = Query();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
      jj_consume_token(COMMA);
      w = Queries();
                                             {if (true) return new AndQuery(v, w);}
      break;
    default:
      jj_la1[41] = jj_gen;
      ;
 ...
 APLIdent ident;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x3ec00,0x0,0x100000,0xf4800000,0x300000,0xf4800000,0x0,0x3ec00,0x0,0x0,0x0,0x0,0x300000,0x100000,0x0,0x100000,0x40000,0x0,0x0,0x4800000,0x20000000,0xd0000000,0x4800000,0xf0000000,0x0,0xf4800000,0xf4800000,0xf4800000,0xf4800000,0x1000000,0x1000000,0x400000,0x8000000,0x8000000,0x0,0x0,0x0,0x300000,0x300000,0xf4800000,0x0,0x0,0x200000,0x100000,0x80000,0x0,0x40000,0x100000,0x40000,0x40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x80000,0x1e42cb00,0xe029f13,0x1e62cb00,0xe029f13,0x4000000,0x0,0x7c000b00,0x8000b00,0x20,0x80000,0x1e42cb00,0x1e42cb00,0x20,0x1e42cb00,0x0,0x1e42cb00,0x1e42cb00,0x20000,0x4000000,0x8001b03,0x20000,0xc001b03,0x1e42cb00,0xe029f13,0xe029f13,0xe0a9f13,0xe0a9f13,0x0,0x0,0x0,0x0,0x0,0x6c004b00,0x1a404b00,0x4000000,0x1e62cb00,0x1e62cb00,0xe029f13,0x4000000,0x20,0x0,0x1e42cb00,0x0,0x8000,0x0,0x0,0x20,0x20,0x1e42cb00,0x8004b00,0x20,0x8024b00,0x80000000,0x1e42cb00,0x2000000,0x2000000,0x10400000,0xc004b00,0x1e42cb00,0x0,0x0,0x1000000,0x1e42cb00,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x1,0x1,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x0,0x1,0x0,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x1,0x1,0x1,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x1,0x1,0x1,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x1,0x1,0xc,0xc,0x0,0x1,};
   }
